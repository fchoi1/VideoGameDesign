...
public class RootMotionControlScript : MonoBehaviour
{
    ...
    void OnAnimatorMove()
    {
        ...
        Vector3 scaledPosition = Vector3.LerpUnclamped(currentPosition, newRootPosition, rootMovementSpeed);
        Quaternion scaledRotation = Quaternion.LerpUnclamped(currentRotation, newRootRotation, rootTurnSpeed);
